...
public class RpcRequestByteToMessageDecoder extends ByteToMessageDecoder {
...
//        System.out.println("readL:"+readL);
        ...
        if(len <= 0){
            ...
            System.out.println("decode:close");
            return;
        }
        ...
        RpcRequest request = objectMapper.readValue(b, RpcRequest.class);
        list.add(request);
